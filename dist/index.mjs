import pe, { createContext as ft, useContext as pt, useState as oe, useRef as Ke, useCallback as We } from "react";
var Ee = /* @__PURE__ */ ((a) => (a.WAIT_REQUEST_CONNECT = "WAIT_REQUEST_CONNECT", a.CONNECTED = "CONNECTED", a.DISCONNECTED = "DISCONNECTED", a))(Ee || {}), Te = /* @__PURE__ */ ((a) => (a.UNREGISTERED = "UNREGISTERED", a.REGISTERED = "REGISTERED", a))(Te || {}), Oe = /* @__PURE__ */ ((a) => (a.INCOMING = "INCOMING", a.OUTGOING = "OUTGOING", a))(Oe || {});
const mt = "0.21.1";
...
function Ye(a, e) {
  ...
  function t(i, n) {
    ...
    return !(!o.filter((g) => d.includes(g)).every((g) => i.parameters[g] === n.parameters[g]) || !["user", "ttl", "method", "transport"].every((g) => i.hasParam(g) && n.hasParam(g) || !i.hasParam(g) && !n.hasParam(g)) || !["maddr"].every((g) => i.hasParam(g) && n.hasParam(g) || !i.hasParam(g) && !n.hasParam(g)));
  }
  if (!t(a, e))
    return !1;
...
class le extends Error {
  constructor(e, t, r, s) {
    super(), this.message = e, this.expected = t, this.found = r, this.location = s, this.name = "SyntaxError", typeof Object.setPrototypeOf == "function" ? Object.setPrototypeOf(this, le.prototype) : this.__proto__ = le.prototype, typeof Error.captureStackTrace == "function" && Error.captureStackTrace(this, le);
  }
  static buildMessage(e, t) {
    ...
    function s(p) {
      return p.replace(/\\/g, "\\\\").replace(/"/g, '\\"').replace(/\0/g, "\\0").replace(/\t/g, "\\t").replace(/\n/g, "\\n").replace(/\r/g, "\\r").replace(/[\x00-\x0F]/g, (g) => "\\x0" + r(g)).replace(/[\x10-\x1F\x7F-\x9F]/g, (g) => "\\x" + r(g));
    }
    function i(p) {
    ...
    function n(p) {
      switch (p.type) {
        case "literal":
          return '"' + s(p.text) + '"';
        case "class":
          const g = p.parts.map((w) => Array.isArray(w) ? i(w[0]) + "-" + i(w[1]) : i(w));
          return "[" + (p.inverted ? "^" : "") + g + "]";
        case "any":
  ...
  format(e) {
    ...
    if (this.location) {
      ...
      if (r) {
        let o = this.location.end, d = ke("", i.line.toString().length, " "), p = r[i.line - 1], g = i.line === o.line ? o.column : p.length + 1;
        t += `
 --> ` + n + `
` + d + ` |
` + i.line + " | " + p + `
` + d + " | " + ke("", i.column - 1, " ") + ke("", g - i.column, "^");
      } else
        t += `
 at ` + n;
    }
...
`, !1),
    ...
    function(h, E) {
      e = e || { data: {} }, e.data.uri_params || (e.data.uri_params = {}), E === null ? E = void 0 : E = E[1], e.data.uri_params[h.toLowerCase()] = E;
    },
    function(h, E) {
      h = h.join("").toLowerCase(), E = E.join(""), e = e || { data: {} }, e.data.uri_headers || (e.data.uri_headers = {}), e.data.uri_headers[h] ? e.data.uri_headers[h].push(E) : e.data.uri_headers[h] = [E];
    },
    function() {
    ...
    function() {
      var h, E;
      for (e = e || { data: {} }, E = e.data.multi_header.length, h = 0; h < E; h++)
    ...
    function() {
      ...
      try {
        h = new U(e.data.uri, e.data.displayName, e.data.params), delete e.data.uri, delete e.data.displayName, delete e.data.params;
      } catch {
        h = null;
      }
    ...
    function(h, E) {
      e = e || { data: {} }, e.data.params || (e.data.params = {}), E === null ? E = void 0 : E = E[1], e.data.params[h.toLowerCase()] = E;
    },
    "render",
    f("render", !0),
    "session",
    ...
    function() {
      e = e || { data: {} };
      var h = e.data.tag;
      e.data = new U(e.data.uri, e.data.displayName, e.data.params), h && e.data.setParam("tag", h);
    },
    "tag",
    f("tag", !0),
    function(h) {
  ...
  function f(h, E) {
    return { type: "literal", text: h, ignoreCase: E };
  }
  function C(h, E, l) {
    return { type: "class", parts: h, inverted: E, ignoreCase: l };
  }
  function ee() {
    return { type: "end" };
  }
  function H(h) {
    ...
    for (E = g[l], E = {
      ...
      a.charCodeAt(l) === 10 ? (E.line++, E.column = 1) : E.column++, l++;
    return g[h] = E, E;
  }
  function N(h, E) {
    const l = H(h), V = H(E);
  ...
  function Le(h) {
    d < w || (d > w && (w = d, b = []), b.push(h));
  }
  function lt(h, E, l) {
    return new le(le.buildMessage(h, E), h, E, l);
  }
  function c(h) {
    return h.split("").map((E) => E.charCodeAt(0) - 32);
  }
  function Ge(h) {
    const E = o[h];
    let l = 0;
      ...
      for (; l < D; )
        switch (E[l]) {
          ...
          case 10:
            ...
            break;
          case 11:
            R.push(R.splice(R.length - E[l + 1], E[l + 1])), l += 2;
            break;
          case 12:
            R.push(a.substring(R.pop(), d)), l++;
            break;
          case 13:
            Z.push(D), V.push(l + 3 + E[l + 1] + E[l + 2]), R[R.length - 1] ? (D = l + 3 + E[l + 1], l += 3) : (D = l + 3 + E[l + 1] + E[l + 2], l += 3 + E[l + 1]);
            break;
          case 14:
            Z.push(D), V.push(l + 3 + E[l + 1] + E[l + 2]), R[R.length - 1] === t ? (D = l + 3 + E[l + 1], l += 3) : (D = l + 3 + E[l + 1] + E[l + 2], l += 3 + E[l + 1]);
            break;
          case 15:
            Z.push(D), V.push(l + 3 + E[l + 1] + E[l + 2]), R[R.length - 1] !== t ? (D = l + 3 + E[l + 1], l += 3) : (D = l + 3 + E[l + 1] + E[l + 2], l += 3 + E[l + 1]);
            break;
          case 16:
            R[R.length - 1] !== t ? (Z.push(D), V.push(l), D = l + 2 + E[l + 1], l += 2) : l += 2 + E[l + 1];
            break;
          case 17:
            Z.push(D), V.push(l + 3 + E[l + 1] + E[l + 2]), a.length > d ? (D = l + 3 + E[l + 1], l += 3) : (D = l + 3 + E[l + 1] + E[l + 2], l += 3 + E[l + 1]);
            break;
          case 18:
            Z.push(D), V.push(l + 4 + E[l + 2] + E[l + 3]), a.substr(d, n[E[l + 1]].length) === n[E[l + 1]] ? (D = l + 4 + E[l + 2], l += 4) : (D = l + 4 + E[l + 2] + E[l + 3], l += 4 + E[l + 2]);
            break;
          case 19:
            Z.push(D), V.push(l + 4 + E[l + 2] + E[l + 3]), a.substr(d, n[E[l + 1]].length).toLowerCase() === n[E[l + 1]] ? (D = l + 4 + E[l + 2], l += 4) : (D = l + 4 + E[l + 2] + E[l + 3], l += 4 + E[l + 2]);
            break;
          case 20:
            Z.push(D), V.push(l + 4 + E[l + 2] + E[l + 3]), n[E[l + 1]].test(a.charAt(d)) ? (D = l + 4 + E[l + 2], l += 4) : (D = l + 4 + E[l + 2] + E[l + 3], l += 4 + E[l + 2]);
            break;
          case 21:
            R.push(a.substr(d, E[l + 1])), d += E[l + 1], l += 2;
            break;
          case 22:
            R.push(n[E[l + 1]]), d += n[E[l + 1]].length, l += 2;
            break;
          case 23:
            R.push(t), y === 0 && Le(n[E[l + 1]]), l += 2;
            break;
          case 24:
            p = R[R.length - 1 - E[l + 1]], l += 2;
            break;
          case 25:
            p = d, l++;
            break;
          case 26:
            Ve = E.slice(l + 4, l + 4 + E[l + 3]).map(function(gt) {
              return R[R.length - 1 - gt];
            }), R.splice(R.length - E[l + 2], E[l + 2], n[E[l + 1]].apply(null, Ve)), l += 4 + E[l + 3];
            break;
          case 27:
            R.push(Ge(E[l + 1])), l += 2;
            break;
          ...
          case 29:
            ...
            break;
          default:
            throw new Error("Invalid opcode: " + E[l] + ".");
        }
      if (Z.length > 0)
        D = Z.pop(), l = V.pop();
      else
  ...
  if (A = Ge(i), A !== t && d === a.length)
    return A;
  throw A !== t && d < a.length && Le(ee()), lt(b, w < a.length ? a.charAt(w) : null, w < a.length ? N(w, w + 1) : N(w, w));
}
const Rt = xt;
var _;
(function(a) {
...
class Qe {
  ...
  addHeader(e, t) {
    const r = { raw: t };
    e = J(e), this.headers[e] ? this.headers[e].push(r) : this.headers[e] = [r];
  }
  /**
  ...
  parseHeader(e, t = 0) {
    ...
    if (r.parsed)
      return r.parsed;
    const i = _.parse(s, e.replace(/-/g, "_"));
    if (i === -1) {
...
class de {
  constructor(e, t, r, s, i, n, o) {
    this.headers = {}, this.extraHeaders = [], this.options = de.getDefaultOptions(), i && (this.options = Object.assign(Object.assign({}, this.options), i), this.options.optionTags && this.options.optionTags.length && (this.options.optionTags = this.options.optionTags.slice()), this.options.routeSet && this.options.routeSet.length && (this.options.routeSet = this.options.routeSet.slice())), n && n.length && (this.extraHeaders = n.slice()), o && (this.body = {
      body: o.content,
      contentType: o.contentType
    }), this.method = e, this.ruri = t.clone(), this.fromURI = r.clone(), this.fromTag = this.options.fromTag ? this.options.fromTag : He(), this.from = de.makeNameAddrHeader(this.fromURI, this.options.fromDisplayName, this.fromTag), this.toURI = s.clone(), this.toTag = this.options.toTag, this.to = de.makeNameAddrHeader(this.toURI, this.options.toDisplayName, this.toTag), this.callId = this.options.callId ? this.options.callId : this.options.callIdPrefix + ce(15), this.cseq = this.options.cseq, this.setHeader("route", this.options.routeSet), this.setHeader("via", ""), this.setHeader("to", this.to.toString()), this.setHeader("from", this.from.toString()), this.setHeader("cseq", this.cseq + " " + this.method), this.setHeader("call-id", this.callId), this.setHeader("max-forwards", "70");
  }
...
function $e(a) {
  ...
  return { contentDisposition: et(t), contentType: t, content: e };
}
function tt(a) {
...
function ve(a) {
  ...
  if (tt(a) && (e = a.contentDisposition, t = a.contentType, r = a.content), !!r) {
    if (t && !e && (e = et(t)), !e)
...
class ge {
   ...
   */
  constructor(e, t = {}) {
    this.pendingReinvite = !1, this.pendingReinviteAck = !1, this._state = m.Initial, this.delegate = t.delegate, this._stateEventEmitter = new Re(), this._userAgent = e;
  }
  /**
   * Destructor.
   */
  ...
  info(e = {}) {
    if (this.state !== m.Established) {
      const s = "Session.info() may only be called if established session.";
  ...
  invite(e = {}) {
    ...
    if (this.pendingReinvite)
      return Promise.reject(new xe("Reinvite in progress. Please wait until complete, then try again."));
      ...
      onAccept: (i) => {
        ...
        if (e.withoutSdp) {
          ...
          this.setOfferAndGetAnswer(n, o).then((d) => {
            ...
            this.logger.error("Failed to handle offer in 2xx response to re-INVITE"), this.logger.error(d.message), this.state === m.Terminated ? i.ack() : (this.ackAndBye(i, 488, "Bad Media Description"), this.stateTransition(m.Terminated));
          }).then(() => {
          ...
          this.setAnswer(n, o).then(() => {
            ...
            this.logger.error("Failed to handle answer in 2xx response to re-INVITE"), this.logger.error(d.message), this.state !== m.Terminated ? (this.ackAndBye(i, 488, "Bad Media Description"), this.stateTransition(m.Terminated)) : i.ack();
          }).then(() => {
            this.pendingReinvite = !1, e.requestDelegate && e.requestDelegate.onAccept && e.requestDelegate.onAccept(i);
          });
        }
    ...
    if (r.extraHeaders = (r.extraHeaders || []).slice(), r.extraHeaders.push("Allow: " + ie.toString()), r.extraHeaders.push("Contact: " + this._contact), e.withoutSdp) {
      if (!this.dialog)
  ...
  message(e = {}) {
    if (this.state !== m.Established) {
      const s = "Session.message() may only be called if established session.";
      return this.logger.error(s), Promise.reject(new Error(`Invalid session state ${this.state}`));
    }
    const t = e.requestDelegate, r = this.copyRequestOptions(e.requestOptions);
   ...
   */
  onAckRequest(e) {
    if (this.logger.log("Session.onAckRequest"), this.state !== m.Established && this.state !== m.Terminating)
  ...
  onInviteRequest(e) {
    ...
    if (e.message.hasHeader("P-Asserted-Identity")) {
      ...
      this._assertedIdentity = _.nameAddrHeaderParse(s);
    }
    const r = {
      sessionDescriptionHandlerOptions: this.sessionDescriptionHandlerOptionsReInvite,
      sessionDescriptionHandlerModifiers: this.sessionDescriptionHandlerModifiersReInvite
  ...
  getOffer(e) {
    ...
    try {
      return t.getDescription(r, s).then((i) => $e(i)).catch((i) => {
  ...
  setOfferAndGetAnswer(e, t) {
    ...
    try {
      return r.setDescription(e.content, s, i).then(() => r.getDescription(s, i)).then((n) => $e(n)).catch((n) => {
...
class we extends ge {
  ...
  constructor(e, t) {
    ...
    if (this.userNoAnswerTimer = setTimeout(() => {
      t.reject({ statusCode: 480 }), this.stateTransition(m.Terminated);
      ...
      this.expiresTimer = setTimeout(() => {
        this.state === m.Initial && (t.reject({ statusCode: 487 }), this.stateTransition(m.Terminated));
      }, d);
    }
    const n = this.request.getHeader("P-Asserted-Identity");
    n && (this._assertedIdentity = _.nameAddrHeaderParse(n)), this._contact = this.userAgent.contact.toString();
  ...
  progress(e = {}) {
    ...
    }).catch((r) => this.handleResponseError(r)) : this.rel100 !== "required" && !(this.rel100 === "supported" && e.rel100) && !(this.rel100 === "supported" && this.userAgent.configuration.sipExtension100rel === Y.Required) ? this.sendProgress(e).then(() => {
  ...
  reject(e = {}) {
    ...
    const t = e.statusCode || 480, r = e.reasonPhrase ? e.reasonPhrase : Ae(t), s = e.extraHeaders || [];
    if (t < 300 || t > 699)
      throw new TypeError("Invalid statusCode: " + t);
    const i = e.body ? $e(e.body) : void 0;
    return t < 400 ? this.incomingInviteRequest.redirect([], { statusCode: t, reasonPhrase: r, extraHeaders: s, body: i }) : this.incomingInviteRequest.reject({ statusCode: t, reasonPhrase: r, extraHeaders: s, body: i }), this.stateTransition(m.Terminated), Promise.resolve();
  }
  /**
  ...
  handleResponseError(e) {
    let t = 480;
    if (e instanceof Error ? this.logger.error(e.message) : this.logger.error(e), e instanceof Me ? (this.logger.error("A session description handler occurred while sending response (content type unsupported"), t = 415) : e instanceof wt ? this.logger.error("A session description handler occurred while sending response") : e instanceof _e ? this.logger.error("Session ended before response could be formulated and sent (while waiting for PRACK)") : e instanceof se && this.logger.error("Session changed state before response could be formulated and sent"), this.state === m.Initial || this.state === m.Establishing)
      try {
   ...
   */
  sendProgress(e = {}) {
    const t = e.statusCode || 180, r = e.reasonPhrase, s = (e.extraHeaders || []).slice(), i = e.body ? $e(e.body) : void 0;
    if (t === 183 && !i)
  ...
  sendProgressReliableWaitForPrack(e = {}) {
    ...
    return new Promise((o, d) => {
      this.waitingForPrack = !0, this.generateResponseOfferAnswer(this.incomingInviteRequest, t).then((p) => (n = p, this.incomingInviteRequest.progress({ statusCode: r, reasonPhrase: s, extraHeaders: i, body: n }))).then((p) => {
        this._dialog = p.session;
        let g, w;
        p.session.delegate = {
          onPrack: (f) => {
            g = f, clearTimeout(y), clearTimeout(B), this.waitingForPrack && (this.waitingForPrack = !1, this.handlePrackOfferAnswer(g).then((C) => {
              try {
                w = g.accept({ statusCode: 200, body: C }), this.prackArrived(), o({ prackRequest: g, prackResponse: w, progressResponse: p });
              } catch (ee) {
                d(ee);
              }
            }).catch((C) => d(C)));
        ...
        const y = setTimeout(() => {
          this.waitingForPrack && (this.waitingForPrack = !1, this.logger.warn("No PRACK received, rejecting INVITE."), clearTimeout(B), this.reject({ statusCode: 504 }).then(() => d(new _e())).catch((f) => d(f)));
        }, F.T1 * 64), A = () => {
          try {
   ...
   */
  prackNeverArrived() {
    this.waitingForPrackReject && this.waitingForPrackReject(new _e()), this.waitingForPrackPromise = void 0, this.waitingForPrackResolve = void 0, this.waitingForPrackReject = void 0;
  }
}
class be extends ge {
  /**
  ...
  constructor(e, t, r = {}) {
    ...
    if (s.params.fromUri && (o = typeof s.params.fromUri == "string" ? _.URIParse(s.params.fromUri) : s.params.fromUri), !o)
      throw new TypeError("Invalid from URI: " + s.params.fromUri);
    let d = t;
    if (s.params.toUri && (d = typeof s.params.toUri == "string" ? _.URIParse(s.params.toUri) : s.params.toUri), !d)
      throw new TypeError("Invalid to URI: " + s.params.toUri);
    const p = Object.assign({}, s.params);
    p.fromTag = this.fromTag;
    const g = (s.extraHeaders || []).slice();
    i && e.configuration.uri && (g.push("P-Preferred-Identity: " + e.configuration.uri.toString()), g.push("Privacy: id")), g.push("Contact: " + n), g.push("Allow: " + ["ACK", "CANCEL", "INVITE", "MESSAGE", "BYE", "OPTIONS", "INFO", "NOTIFY", "REFER"].toString()), e.configuration.sipExtension100rel === Y.Required && g.push("Require: 100rel"), e.configuration.sipExtensionReplaces === Y.Required && g.push("Require: replaces"), s.extraHeaders = g;
    const w = void 0;
  ...
  cancel(e = {}) {
    ...
    if (this.outgoingInviteRequest) {
      ...
      this.logger.warn("Canceled session before INVITE was sent"), this.stateTransition(m.Terminated);
    return Promise.resolve();
  }
  /**
   ...
   */
  invite(e = {}) {
    if (this.logger.log("Inviter.invite"), this.state !== m.Initial)
    ...
    if (e.sessionDescriptionHandlerModifiers && (this.sessionDescriptionHandlerModifiers = e.sessionDescriptionHandlerModifiers), e.sessionDescriptionHandlerOptions && (this.sessionDescriptionHandlerOptions = e.sessionDescriptionHandlerOptions), e.withoutSdp || this.inviteWithoutSdp)
      return this._renderbody && this._rendertype && (this.outgoingRequestMessage.body = { contentType: this._rendertype, body: this._renderbody }), this.stateTransition(m.Establishing), Promise.resolve(this.sendInvite(e));
    const t = {
      sessionDescriptionHandlerModifiers: this.sessionDescriptionHandlerModifiers,
      sessionDescriptionHandlerOptions: this.sessionDescriptionHandlerOptions
    };
    return this.getOffer(t).then((r) => (this.outgoingRequestMessage.body = { body: r.content, contentType: r.contentType }, this.stateTransition(m.Establishing), this.sendInvite(e))).catch((r) => {
      throw this.logger.log(r.message), this.state !== m.Terminated && this.stateTransition(m.Terminated), r;
    });
  }
  /**
   ...
   */
  onAccept(e) {
    if (this.logger.log("Inviter.onAccept"), this.state !== m.Establishing)
    ...
    switch (t.hasHeader("P-Asserted-Identity") && (this._assertedIdentity = _.nameAddrHeaderParse(t.getHeader("P-Asserted-Identity"))), r.delegate = {
      onAck: (s) => this.onAckRequest(s),
      onBye: (s) => this.onByeRequest(s),
      onInfo: (s) => this.onInfoRequest(s),
      onInvite: (s) => this.onInviteRequest(s),
      ...
      case T.HaveRemoteOffer: {
        ...
        return this.setOfferAndGetAnswer(this._dialog.offer, s).then((i) => {
          e.ack({ body: i }), this.stateTransition(m.Established);
        }).catch((i) => {
  ...
  onProgress(e) {
    var t;
    if (this.logger.log("Inviter.onProgress"), this.state !== m.Establishing)
    ...
    r.hasHeader("P-Asserted-Identity") && (this._assertedIdentity = _.nameAddrHeaderParse(r.getHeader("P-Asserted-Identity")));
    const i = r.getHeader("require"), n = r.getHeader("rseq"), d = !!(i && i.includes("100rel") && n ? Number(n) : void 0), p = [];
    switch (d && p.push("RAck: " + r.getHeader("rseq") + " " + r.getHeader("cseq")), s.signalingState) {
      case T.Initial:
      ...
      case T.HaveRemoteOffer:
        ...
        {
          const g = this.sessionDescriptionHandlerFactory(this, this.userAgent.configuration.sessionDescriptionHandlerFactoryOptions || {});
      ...
      case T.Stable:
        if (d && e.prack({ extraHeaders: p }), this.earlyMedia && !this.earlyMediaDialog) {
          ...
          return this.setAnswer(g, w).catch((b) => {
            throw this.stateTransition(m.Terminated), b;
          });
        }
        return Promise.resolve();
      case T.Closed:
...
class yt {
  ...
  constructor(e, t, r, s = "text/plain", i = {}) {
    ...
    if (i.params.fromUri && (n = typeof i.params.fromUri == "string" ? _.URIParse(i.params.fromUri) : i.params.fromUri), !n)
      throw new TypeError("Invalid from URI: " + i.params.fromUri);
    let o = t;
    if (i.params.toUri && (o = typeof i.params.toUri == "string" ? _.URIParse(i.params.toUri) : i.params.toUri), !o)
      throw new TypeError("Invalid to URI: " + i.params.toUri);
    const d = i.params ? Object.assign({}, i.params) : {}, p = (i.extraHeaders || []).slice(), w = {
      contentDisposition: "render",
      contentType: s,
      content: r
    };
    this.request = e.userAgentCore.makeOutgoingRequestMessage(v.MESSAGE, t, n, o, d, p, w), this.userAgent = e;
  }
  /**
   * Send the message.
   */
...
class z {
   ...
   */
  constructor(e, t = {}) {
    this.disposed = !1, this._contacts = [], this._retryAfter = void 0, this._state = I.Initial, this._waiting = !1, this._stateEventEmitter = new Re(), this._waitingEventEmitter = new Re(), this.userAgent = e;
    ...
    if (this.options.registrar = this.options.registrar.clone(), this.options.regId && !this.options.instanceId ? this.options.instanceId = this.userAgent.instanceId : !this.options.regId && this.options.instanceId && (this.options.regId = 1), this.options.instanceId && _.parse(this.options.instanceId, "uuid") === -1)
    ...
    if (this.request = e.userAgentCore.makeOutgoingRequestMessage(v.REGISTER, s, i, n, o, d, void 0), this.expires = this.options.expires || z.defaultExpires, this.expires < 0)
    ...
    this.logger = e.getLogger("sip.Registerer"), this.options.logConfiguration && (this.logger.log("Configuration:"), Object.keys(this.options).forEach((p) => {
      const g = this.options[p];
      switch (p) {
        case "registrar":
          this.logger.log("· " + p + ": " + g);
          break;
        default:
          this.logger.log("· " + p + ": " + JSON.stringify(g));
      }
  ...
  dispose() {
    return this.disposed ? Promise.resolve() : (this.disposed = !0, this.logger.log(`Registerer ${this.id} in state ${this.state} is being disposed`), delete this.userAgent._registerers[this.id], new Promise((e) => {
      const t = () => {
        if (!this.waiting && this._state === I.Registered) {
  ...
  register(e = {}) {
    ...
    if (this.waiting) {
      this.waitingWarning();
      const s = new xe("REGISTER request already in progress, waiting for final response");
    ...
    const r = this.userAgent.userAgentCore.register(this.request, {
      onAccept: (s) => {
        ...
        if (o.hasParam("temp-gruu")) {
          ...
          d && (this.userAgent.contact.tempGruu = _.URIParse(d.replace(/"/g, "")));
        }
        if (o.hasParam("pub-gruu")) {
          const d = o.getParam("pub-gruu");
          d && (this.userAgent.contact.pubGruu = _.URIParse(d.replace(/"/g, "")));
        }
  ...
  unregister(e = {}) {
    if (this.state === I.Terminated)
      throw this.stateError(), new Error("Registerer terminated. Unable to register.");
    if (this.disposed && this.state !== I.Registered)
      throw this.stateError(), new Error("Registerer disposed. Unable to register.");
    if (this.waiting) {
      this.waitingWarning();
      const s = new xe("REGISTER request already in progress, waiting for final response");
    ...
    this._state !== I.Registered && !e.all && this.logger.warn("Not currently registered, but sending an unregister anyway.");
  ...
  registered(e) {
    ...
    }, e * 1e3), this._state !== I.Registered && this.stateTransition(I.Registered);
  }
  /**
   * Helper function, called when unregistered.
   */
  unregistered() {
    this.clearTimers(), this._state !== I.Unregistered && this.stateTransition(I.Unregistered);
  }
  /**
   * Helper function, called when terminated.
   */
  terminated() {
    this.clearTimers(), this._state !== I.Terminated && this.stateTransition(I.Terminated);
  }
  /**
  ...
  stateTransition(e) {
    ...
    switch (this._state) {
      case I.Initial:
        e !== I.Registered && e !== I.Unregistered && e !== I.Terminated && t();
        break;
      case I.Registered:
        e !== I.Unregistered && e !== I.Terminated && t();
        break;
      case I.Unregistered:
        e !== I.Registered && e !== I.Terminated && t();
        break;
      case I.Terminated:
        t();
        break;
    ...
    this._state = e, this.logger.log(`Registration transitioned to state ${this._state}`), this._stateEventEmitter.emit(this._state), e === I.Terminated && this.dispose();
  }
  ...
  /** Hopefully helpful as the standard behavior has been found to be unexpected. */
  stateError() {
    let t = `An attempt was made to send a REGISTER request when the Registerer ${this.state === I.Terminated ? "is in 'Terminated' state" : "has been disposed"}.`;
...
class k {
  ...
  appendStr(e) {
    ...
    for (n = 0; n < e.length; n += 1) {
      ...
      s >= 64 && (this._dataLength += 64, k._md5cycle(this._state, r), s -= 64, r[0] = r[16]);
    }
  ...
  appendAsciiStr(e) {
    ...
    for (; ; ) {
      ...
      if (s < 64)
        break;
      this._dataLength += 64, k._md5cycle(this._state, r), s = 0;
    }
    return this._bufferLength = s, this;
  }
  appendByteArray(e) {
  ...
  setState(e) {
    ...
    let n;
    if (this._dataLength += t, r[t] = 128, r[t + 1] = r[t + 2] = r[t + 3] = 0, s.set(k.buffer32Identity.subarray(i), i), t > 55 && (k._md5cycle(this._state, s), s.set(k.buffer32Identity)), n = this._dataLength * 8, n <= 4294967295)
      s[14] = n;
    else {
      const o = n.toString(16).match(/(.*?)(.{0,8})$/);
      if (o === null)
        return;
      const d = parseInt(o[2], 16), p = parseInt(o[1], 16) || 0;
      s[14] = d, s[15] = p;
    }
    return k._md5cycle(this._state, s), e ? this._state : k._hex(this._state);
  }
}
...
k.hashStr("hello") !== "5d41402abc4b2a76b9719d911017c592" && console.error("Md5 self test failed.");
function re(a) {
  return k.hashStr(a);
}
class Dt {
  ...
  authenticate(e, t, r) {
    ...
    if (t.qop)
      ...
      this.qop = void 0;
    return this.method = e.method, this.uri = e.ruri, this.cnonce = ce(12), this.nc += 1, this.updateNcHex(), this.nc === 4294967296 && (this.nc = 1, this.ncHex = "00000001"), this.calculateResponse(r), !0;
  }
  /**
  ...
  calculateResponse(e) {
    let t, r;
    t = this.ha1, (t === "" || t === void 0) && (t = re(this.username + ":" + this.realm + ":" + this.password)), this.qop === "auth" ? (r = re(this.method + ":" + this.uri), this.response = re(t + ":" + this.nonce + ":" + this.ncHex + ":" + this.cnonce + ":auth:" + r)) : this.qop === "auth-int" ? (r = re(this.method + ":" + this.uri + ":" + re(e || "")), this.response = re(t + ":" + this.nonce + ":" + this.ncHex + ":" + this.cnonce + ":auth-int:" + r)) : this.qop === void 0 && (r = re(this.method + ":" + this.uri), this.response = re(t + ":" + this.nonce + ":" + r));
  }
}
var q;
(function(a) {
...
`, n), d === -1)
  ...
  a.getHeader = e;
  function t(s, i, n, o) {
    const d = i.indexOf(":", n), p = i.substring(n, d).trim(), g = i.substring(d + 1, o).trim();
    let w;
    switch (p.toLowerCase()) {
      case "via":
      case "v":
        s.addHeader("via", g), s.getHeaders("via").length === 1 ? (w = s.parseHeader("Via"), w && (s.via = w, s.viaBranch = w.branch)) : w = 0;
        break;
      case "from":
      case "f":
        s.setHeader("from", g), w = s.parseHeader("from"), w && (s.from = w, s.fromTag = w.getParam("tag"));
        break;
      case "to":
      case "t":
        s.setHeader("to", g), w = s.parseHeader("to"), w && (s.to = w, s.toTag = w.getParam("tag"));
        break;
      case "record-route":
        if (w = _.parse(g, "Record_Route"), w === -1) {
          w = void 0;
          break;
        }
        ...
        w.forEach((b) => {
          s.addHeader("record-route", g.substring(b.position, b.offset)), s.headers["Record-Route"][s.getHeaders("record-route").length - 1].parsed = b.parsed;
        });
        break;
      case "call-id":
      case "i":
        s.setHeader("call-id", g), w = s.parseHeader("call-id"), w && (s.callId = g);
        break;
      case "contact":
      case "m":
        if (w = _.parse(g, "Contact"), w === -1) {
          w = void 0;
          break;
        }
        if (!(w instanceof Array)) {
        ...
        w.forEach((b) => {
          s.addHeader("contact", g.substring(b.position, b.offset)), s.headers.Contact[s.getHeaders("contact").length - 1].parsed = b.parsed;
        });
        break;
      case "content-length":
      case "l":
        s.setHeader("content-length", g), w = s.parseHeader("content-length");
        break;
      case "content-type":
      case "c":
        s.setHeader("content-type", g), w = s.parseHeader("content-type");
        break;
      case "cseq":
        s.setHeader("cseq", g), w = s.parseHeader("cseq"), w && (s.cseq = w.value), s instanceof ae && (s.method = w.method);
        break;
      case "max-forwards":
        s.setHeader("max-forwards", g), w = s.parseHeader("max-forwards");
        break;
      case "www-authenticate":
        s.setHeader("www-authenticate", g), w = s.parseHeader("www-authenticate");
        break;
      case "proxy-authenticate":
        s.setHeader("proxy-authenticate", g), w = s.parseHeader("proxy-authenticate");
        break;
      case "refer-to":
      case "r":
        s.setHeader("refer-to", g), w = s.parseHeader("refer-to"), w && (s.referTo = w);
        break;
      default:
        s.addHeader(p.toLowerCase(), g), w = 0;
    }
    return w === void 0 ? {
      error: "error parsing header '" + p + "'"
    } : !0;
  }
  a.parseHeader = t;
  function r(s, i) {
...
`);
    ...
    const d = s.substring(0, o), p = _.parse(d, "Request_Response");
    let g;
    if (p === -1) {
      i.warn('error parsing first line of SIP message: "' + d + '"');
      return;
    } else
      p.status_code ? (g = new ae(), g.statusCode = p.status_code, g.reasonPhrase = p.reason_phrase) : (g = new ue(), g.method = p.method, g.ruri = p.uri);
    g.data = s, n = o + 2;
    let w;
    for (; ; ) {
      if (o = e(s, n), o === -2) {
    ...
    return g.hasHeader("content-length") ? g.body = s.substr(w, Number(g.getHeader("content-length"))) : g.body = s.substring(w), g;
  }
  a.parseMessage = r;
})(Ie = Ie || (Ie = {}));
function st(a, e) {
...
`;
  ...
  const r = e.reasonPhrase ? e.reasonPhrase : Ae(e.statusCode);
  let s = "SIP/2.0 " + e.statusCode + " " + r + t;
  e.statusCode >= 100 && e.statusCode < 200, e.statusCode;
  const i = "From: " + a.getHeader("From") + t, n = "Call-ID: " + a.callId + t, o = "CSeq: " + a.cseq + " " + a.method + t, d = a.getHeaders("via").reduce((y, A) => y + "Via: " + A + t, "");
  ...
  p += t;
  let g = "";
  e.supported && (g = "Supported: " + e.supported.join(", ") + t);
  let w = "";
  e.userAgent && (w = "User-Agent: " + e.userAgent + t);
  let b = "";
  return e.extraHeaders && (b = e.extraHeaders.reduce((y, A) => y + A.trim() + t, "")), s += d, s += i, s += p, s += o, s += n, s += g, s += w, s += b, e.body ? (s += "Content-Type: " + e.body.contentType + t, s += "Content-Length: " + Se(e.body.content) + t + t, s += e.body.content) : s += "Content-Length: 0" + t + t, { message: s };
}
class Fe extends he {
  constructor(e) {
...
class it {
  ...
  send(e) {
    return this.transport.send(e).catch((t) => {
      ...
      let r;
      throw t && typeof t.message == "string" ? r = new Fe(t.message) : r = new Fe(), this.onTransportError(r), r;
    });
  }
  setState(e) {
  ...
  receiveRequest(e) {
    switch (this.state) {
      ...
      case u.Completed:
        ...
        break;
      case u.Confirmed:
        if (e.method === v.INVITE || e.method === v.ACK)
          return;
        break;
      case u.Terminated:
        if (e.method === v.INVITE || e.method === v.ACK)
...
class Pe extends it {
  constructor(e, t, r, s, i) {
    super(t, r, Pe.makeId(e), s, i), this._request = e, this.user = r, e.setViaHeader(this.id, t.protocol);
  }
  static makeId(e) {
    if (e.method === "CANCEL") {
      if (!e.branch)
...
class fe {
  ...
  static initialDialogStateForUserAgentClient(e, t) {
    ...
    const n = i.uri, o = e.cseq, d = void 0, p = e.callId, g = e.fromTag, w = t.toTag;
    if (!p)
  ...
  static initialDialogStateForUserAgentServer(e, t, r = !1) {
    ...
    if (!(n instanceof U))
      throw new Error("Contact not instance of NameAddrHeader.");
    const o = n.uri, d = e.cseq, p = void 0, g = e.callId, w = t, b = e.fromTag, y = e.from.uri, A = e.to.uri;
    return {
      id: g + w + b,
      early: r,
      callId: g,
  ...
  createOutgoingRequestMessage(e, t) {
    ...
    const p = this.remoteTarget, g = this.routeSet, w = t && t.extraHeaders, b = t && t.body;
    return this.userAgentCore.makeOutgoingRequestMessage(e, p, i, r, {
      callId: o,
      cseq: d,
      fromTag: n,
      toTag: s,
...
\r
`, this.send(p).catch((g) => {
      this.logTransportError(g, "Failed to send ACK to non-2xx response.");
    });
  }
  /**
   * Execute a state transition.
...
class O {
  ...
  cancel(e, t = {}) {
    ...
    if (!this.message.from)
      throw new Error("From undefined.");
    const r = this.core.makeOutgoingRequestMessage(v.CANCEL, this.message.ruri, this.message.from.uri, this.message.to.uri, {
      toTag: this.message.toTag,
      fromTag: this.message.fromTag,
      callId: this.message.callId,
      cseq: this.message.cseq
    }, t.extraHeaders);
    return r.branch = this.message.branch, this.message.headers.Route && (r.headers.Route = this.message.headers.Route), e && r.setHeader("Reason", e), this.transaction.state === u.Proceeding ? new O(G, this.core, r) : this.transaction.addStateChangeListener(() => {
      this.transaction && this.transaction.state === u.Proceeding && new O(G, this.core, r);
    }, { once: !0 }), r;
  }
  /**
...
class Ht extends O {
  constructor(e, t, r) {
    const s = e.createOutgoingRequestMessage(v.BYE, r);
    super(G, e.userAgentCore, s, t), e.dispose();
  }
}
class L extends nt {
  /**
...
class Pt extends Q {
  constructor(e, t, r) {
    super(L, e.userAgentCore, t, r);
  }
}
class _t extends O {
  constructor(e, t, r) {
    const s = e.createOutgoingRequestMessage(v.INFO, r);
    super(G, e.userAgentCore, s, t);
  }
}
class kt extends Q {
  constructor(e, t, r) {
...
class qt extends O {
  constructor(e, t, r) {
    const s = e.createOutgoingRequestMessage(v.NOTIFY, r);
    super(G, e.userAgentCore, s, t);
  }
}
function Ft(a) {
...
class Nt extends O {
  constructor(e, t, r) {
    const s = e.createOutgoingRequestMessage(v.PRACK, r);
    super(G, e.userAgentCore, s, t), e.signalingStateTransition(s);
  }
}
class Ot extends Q {
  constructor(e, t, r) {
    super(L, e.userAgentCore, t, r), e.signalingStateTransition(t), this.dialog = e;
  }
  /**
...
class Mt extends O {
  constructor(e, t, r) {
    const s = e.createOutgoingRequestMessage(v.INVITE, r);
...
class Ut extends Q {
  constructor(e, t, r) {
    super(j, e.userAgentCore, t, r), e.reinviteUserAgentServer = this, this.dialog = e;
  }
  /**
   * Update the dialog signaling state on a 2xx response.
   * @param options - Options bucket.
...
class jt extends O {
  constructor(e, t, r) {
    const s = e.createOutgoingRequestMessage(v.REFER, r);
    super(G, e.userAgentCore, s, t);
  }
}
function Bt(a) {
...
class De extends fe {
  ...
  ack(e = {}) {
    ...
    const r = this.createOutgoingRequestMessage(v.ACK, {
      cseq: t.request.cseq,
  ...
  message(e, t) {
    if (this.logger.log(`INVITE dialog ${this.id} sending MESSAGE request`), this.early)
      throw new Error("Dialog not confirmed.");
    const r = this.createOutgoingRequestMessage(v.MESSAGE, t);
    return new at(this.core, r, e);
  }
  /**
   ...
   */
  prack(e, t) {
    return this.logger.log(`INVITE dialog ${this.id} sending PRACK request`), new Nt(this, e, t);
  }
  /**
  ...
  receiveRequest(e) {
    ...
    if (super.receiveRequest(e), e.method === v.INVITE) {
      const t = () => {
  ...
  signalingStateTransition(e) {
    const t = ve(e);
    if (!(!t || t.contentDisposition !== "session")) {
      if (this._signalingState === T.Stable && (this._rollbackOffer = this._offer, this._rollbackAnswer = this._answer), e instanceof ue)
...
class Lt extends O {
  constructor(e, t, r) {
    super(ne, e, t, r), this.confirmedDialogAcks = /* @__PURE__ */ new Map(), this.confirmedDialogs = /* @__PURE__ */ new Map(), this.earlyDialogs = /* @__PURE__ */ new Map(), this.delegate = r;
  }
  dispose() {
      ...
      case /^1[0-9]{2}$/.test(t):
        {
          ...
          if (!i) {
            ...
            if (!(o instanceof ne))
              throw new Error("Transaction not instance of InviteClientTransaction.");
            i = new De(o, this.core, s), this.earlyDialogs.set(i.id, i);
          }
      ...
      case /^2[0-9]{2}$/.test(t):
        {
          ...
          if (i = this.earlyDialogs.get(s.id), i)
            ...
            if (!(o instanceof ne))
              throw new Error("Transaction not instance of InviteClientTransaction.");
            i = new De(o, this.core, s), this.confirmedDialogs.set(i.id, i);
          }
          (i.signalingState === T.Initial || i.signalingState === T.HaveLocalOffer) && i.signalingStateTransition(e);
          const n = i;
...
class Ne extends Q {
  ...
  accept(e = { statusCode: 200 }) {
    ...
    if (!this.confirmedDialog)
      if (this.earlyDialog)
        ...
        this.confirmedDialog = new De(d, this.core, p);
      }
    const t = this.message.getHeaders("record-route").map((d) => `Record-Route: ${d}`), r = `Contact: ${this.core.configuration.contact.toString()}`, s = "Allow: " + ie.toString();
    if (!e.body) {
  ...
  progress(e = { statusCode: 180 }) {
    ...
    if (!this.earlyDialog) {
      ...
      this.earlyDialog = new De(o, this.core, d);
    }
...
class Kt extends Q {
  constructor(e, t, r) {
    super(L, e, t, r), this.core = e;
  }
}
class Wt extends O {
  constructor(e, t, r) {
    const s = e.createOutgoingRequestMessage(v.SUBSCRIBE, r);
    super(G, e.userAgentCore, s, t), this.dialog = e;
  }
  waitNotifyStop() {
  }
  /**
...
class Je extends fe {
  ...
  static initialDialogStateForSubscription(e, t) {
    ...
    if (!(i instanceof U))
      throw new Error("Contact not instance of NameAddrHeader.");
    const n = i.uri, o = e.cseq, d = void 0, p = e.callId, g = e.fromTag, w = t.fromTag;
    if (!p)
      throw new Error("Call id undefined.");
    if (!g)
      throw new Error("From tag undefined.");
    ...
    if (!e.to)
      throw new Error("To undefined.");
    const b = e.from.uri, y = e.to.uri, A = !1;
    return {
      id: p + g + w,
      early: A,
      callId: p,
...
class Yt extends O {
  constructor(e, t, r) {
    ...
    super(G, e, t, r), this.delegate = r, this.subscriberId = t.callId + t.fromTag + s, this.subscriptionExpiresRequested = this.subscriptionExpires = Number(i), this.subscriptionEvent = s, this.subscriptionState = $.NotifyWait, this.waitNotifyStart();
  }
  /**
   * Destructor.
  ...
  onNotify(e) {
    ...
    if (this.subscriptionState !== $.Terminated) {
      const i = Je.initialDialogStateForSubscription(this.message, e.message);
      this.dialog = new Je(this.subscriptionEvent, this.subscriptionExpires, this.subscriptionState, this.core, i);
    }
    if (this.delegate && this.delegate.onNotify) {
...
const ze = ["application/sdp", "application/dtmf-relay"];
class Jt {
  /**
   * Constructor.
  ...
  makeOutgoingRequestMessage(e, t, r, s, i, n, o) {
    const d = this.configuration.sipjsId, p = this.configuration.displayName, g = this.configuration.viaForceRport, w = this.configuration.hackViaTcp, b = this.configuration.supportedOptionTags.slice();
    e === v.REGISTER && b.push("path", "gruu"), e === v.INVITE && (this.configuration.contact.pubGruu || this.configuration.contact.tempGruu) && b.push("gruu");
    const y = this.configuration.routeSet, A = this.configuration.userAgentHeaderFieldValue, S = this.configuration.viaHost, f = Object.assign(Object.assign({}, {
      callIdPrefix: d,
      forceRport: g,
      fromDisplayName: p,
      hackViaTcp: w,
  ...
  receiveRequestFromTransport(e) {
    ...
    if (e.method === v.ACK && r && r.transaction.state === u.Accepted && r instanceof Ne) {
      this.logger.warn(`Discarding out of dialog ACK after 2xx response sent on transaction ${t}.`);
      return;
    }
    if (e.method === v.CANCEL) {
      r ? (this.replyStateless(e, { statusCode: 200 }), r.transaction instanceof j && r.transaction.state === u.Proceeding && r instanceof Ne && r.receiveCancel(e)) : this.replyStateless(e, { statusCode: 481 });
      return;
    }
    if (r) {
  ...
  receiveRequest(e) {
    ...
    if (!r(this.configuration.aor) && !(r(this.configuration.contact.uri) || r(this.configuration.contact.pubGruu) || r(this.configuration.contact.tempGruu))) {
      this.logger.warn("Request-URI does not point to us."), e.method !== v.ACK && this.replyStateless(e, { statusCode: 404 });
      return;
    }
    if (e.method === v.INVITE && !e.hasHeader("Contact")) {
      this.replyStateless(e, {
        statusCode: 400,
  ...
  receiveInsideDialogRequest(e) {
    ...
    if (r) {
      if (e.method === v.OPTIONS) {
        const s = "Allow: " + ie.toString(), i = "Accept: " + ze.toString();
        this.replyStateless(e, {
          statusCode: 200,
          extraHeaders: [s, i]
        });
    ...
    e.method !== v.ACK && this.replyStateless(e, { statusCode: 481 });
  }
  /**
  ...
  receiveOutsideDialogRequest(e) {
    switch (e.method) {
      ...
      case v.OPTIONS:
        {
          const t = "Allow: " + ie.toString(), r = "Accept: " + ze.toString();
          this.replyStateless(e, {
            statusCode: 200,
            extraHeaders: [t, r]
          });
...
class M {
  ...
  setLocalMediaStream(e) {
    ...
    const t = this._peerConnection, r = this._localMediaStream, s = [], i = (d) => {
      const p = d.kind;
      if (p !== "audio" && p !== "video")
        throw new Error(`Unknown new track kind ${p}.`);
      const g = t.getSenders().find((w) => w.track && w.track.kind === p);
      g ? s.push(new Promise((w) => {
        this.logger.debug(`SessionDescriptionHandler.setLocalMediaStream - replacing sender ${p} track`), w();
      }).then(() => g.replaceTrack(d).then(() => {
        const w = r.getTracks().find((b) => b.kind === p);
        ...
        this.logger.debug(`SessionDescriptionHandler.setLocalMediaStream - adding sender ${p} track`), w();
      }).then(() => {
        try {
          t.addTrack(d, r);
        } catch (w) {
    ...
    return o.length && i(o[0]), s.reduce((d, p) => d.then(() => p), Promise.resolve());
  }
  /**
...
function Qt(a) {
  return (e, t) => {
    ...
    const s = {
      ...
      peerConnectionConfiguration: Object.assign(Object.assign({}, Xt()), t == null ? void 0 : t.peerConnectionConfiguration)
...
class Ce {
  constructor(e, t) {
    if (this._state = x.Disconnected, this.transitioningState = !1, this._stateEventEmitter = new Re(), this.logger = e, t) {
      const i = t, n = i == null ? void 0 : i.wsServers, o = i == null ? void 0 : i.maxReconnectionAttempts;
      if (n !== void 0) {
        const d = 'The transport option "wsServers" as has apparently been specified and has been deprecated. It will no longer be available starting with SIP.js release 0.16.0. Please update accordingly.';
        this.logger.warn(d);
      }
      if (o !== void 0) {
        const d = 'The transport option "maxReconnectionAttempts" as has apparently been specified and has been deprecated. It will no longer be available starting with SIP.js release 0.16.0. Please update accordingly.';
        this.logger.warn(d);
      }
      n && !t.server && (typeof n == "string" && (t.server = n), n instanceof Array && (t.server = n[0]));
    }
    this.configuration = Object.assign(Object.assign({}, Ce.defaultOptions), t);
    const r = this.configuration.server, s = _.parse(r, "absoluteURI");
    if (s === -1)
  ...
  transitionState(e, t) {
    ...
    if (s === x.Disconnecting && (this.disconnectPromise = void 0, this.disconnectResolve = void 0, this.disconnectReject = void 0), this.connectTimeout && (clearTimeout(this.connectTimeout), this.connectTimeout = void 0), this.logger.log(`Transitioned from ${s} to ${this._state}`), this._stateEventEmitter.emit(this._state), e === x.Connected && (this.startSendingKeepAlives(), this.onConnect))
      try {
        ...
        throw this.logger.error(p.toString()), this.logger.error("Exception thrown by onConnect callback"), p;
      }
    if (s === x.Connected && (this.stopSendingKeepAlives(), this.onDisconnect))
      try {
        t ? this.onDisconnect(t) : this.onDisconnect();
      } catch (p) {
        throw this.logger.error(p.toString()), this.logger.error("Exception thrown by onDisconnect callback"), p;
      }
    if (s === x.Connecting) {
      if (!i)
...
class W {
   ...
   */
  constructor(e = {}) {
    if (this._publishers = {}, this._registerers = {}, this._sessions = {}, this._subscriptions = {}, this._state = P.Stopped, this._stateEventEmitter = new Re(), this.delegate = e.delegate, this.options = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, W.defaultOptions()), { sipjsId: ce(5) }), { uri: new X("sip", "anonymous." + ce(6), "anonymous.invalid") }), { viaHost: ce(12) + ".invalid" }), W.stripUndefinedProperties(e)), this.options.hackIpInContact)
    ...
    switch (this.loggerFactory = new At(), this.logger = this.loggerFactory.getLogger("sip.UserAgent"), this.loggerFactory.builtinEnabled = this.options.logBuiltinEnabled, this.loggerFactory.connector = this.options.logConnector, this.options.logLevel) {
      case "error":
    ...
    if (this.options.logConfiguration && (this.logger.log("Configuration:"), Object.keys(this.options).forEach((t) => {
      ...
      if (r !== void 0) {
        const i = 'The transport option "maxReconnectionAttempts" as has apparently been specified and has been deprecated. It will no longer be available starting with SIP.js release 0.16.0. Please update accordingly.';
        this.logger.warn(i);
      }
      if (s !== void 0) {
        const i = 'The transport option "reconnectionTimeout" as has apparently been specified and has been deprecated. It will no longer be available starting with SIP.js release 0.16.0. Please update accordingly.';
        this.logger.warn(i);
      }
    ...
    if (e.reconnectionDelay !== void 0) {
      const t = 'The user agent option "reconnectionDelay" as has apparently been specified and has been deprecated. It will no longer be available starting with SIP.js release 0.16.0. Please update accordingly.';
      this.logger.warn(t);
    }
    if (e.reconnectionAttempts !== void 0) {
      const t = 'The user agent option "reconnectionAttempts" as has apparently been specified and has been deprecated. It will no longer be available starting with SIP.js release 0.16.0. Please update accordingly.';
      this.logger.warn(t);
    }
    if (this._transport = new this.options.transportConstructor(this.getLogger("sip.Transport"), this.options.transportOptions), this.initTransportCallbacks(), this._contact = this.initContact(), this._instanceId = this.options.instanceId ? this.options.instanceId : W.newUUID(), _.parse(this._instanceId, "uuid") === -1)
      throw new Error("Invalid instanceId.");
   ...
   */
  reconnect() {
    return this.state === P.Stopped ? Promise.reject(new Error("User agent stopped.")) : Promise.resolve().then(() => this.transport.connect());
  }
  /**
   ...
   */
  start() {
    return this.state === P.Started ? (this.logger.warn("User agent already started"), Promise.resolve()) : (this.logger.log(`Starting ${this.configuration.uri}`), this.transitionState(P.Started), this.transport.connect());
  }
  /**
   * Stop the user agent.
   *
  ...
  async stop() {
    ...
    if (this.logger.log(`Stopping ${this.configuration.uri}`), !this.options.gracefulShutdown)
      return this.logger.log("Dispose of transport"), this.transport.dispose().catch((o) => {
        throw this.logger.error(o.message), o;
      }), this.logger.log("Dispose of core"), this.userAgentCore.dispose(), this._publishers = {}, this._registerers = {}, this._sessions = {}, this._subscriptions = {}, this.transitionState(P.Stopped), Promise.resolve();
    ...
    this.logger.log("Dispose of transport"), await i.dispose().catch((o) => {
      throw this.logger.error(o.message), o;
    }), this.logger.log("Dispose of core"), n.dispose(), this.transitionState(P.Stopped);
  }
  /**
  ...
  initCore() {
    ...
    const r = {
      ...
      authenticationFactory: () => {
        ...
        return new Dt(this.getLoggerFactory(), o, i, n);
      },
      transportAccessor: () => this.transport
    }, s = {
      onInvite: (i) => {
        var n;
        const o = new we(this, i);
        if (i.delegate = {
          onCancel: (d) => {
            o._onCancel(d);
          },
        ...
        }, i.trying(), this.options.sipExtensionReplaces !== Y.Unsupported) {
          const p = i.message.parseHeader("replaces");
          if (p) {
            const g = p.call_id;
            if (typeof g != "string")
              throw new Error("Type of call id is not string");
            const w = p.replaces_to_tag;
            if (typeof w != "string")
              throw new Error("Type of to tag is not string");
            const b = p.replaces_from_tag;
            if (typeof b != "string")
              throw new Error("type of from tag is not string");
            const y = g + w + b, A = this.userAgentCore.dialogs.get(y);
            if (!A) {
            ...
            const S = this._sessions[g + b] || this._sessions[g + w] || void 0;
            if (!S)
  ...
  onTransportConnect() {
    this.state !== P.Stopped && this.delegate && this.delegate.onConnect && this.delegate.onConnect();
  }
  ...
  onTransportMessage(e) {
    ...
    if (this.state === P.Stopped && t instanceof ue) {
    ...
    if (t instanceof ue) {
      ...
      const s = Se(t.body), i = t.getHeader("content-length");
      if (i && s < Number(i)) {
...
class Be {
  ...
  constructor(e, t = {}) {
    this.managedSessions = [], this.attemptingReconnection = !1, this.optionsPingFailure = !1, this.optionsPingRunning = !1, this.shouldBeConnected = !1, this.shouldBeRegistered = !1, this.delegate = t.delegate, this.options = Object.assign({
      ...
      userAgentOptions: {}
    }, Be.stripUndefinedProperties(t));
    const r = Object.assign({}, t.userAgentOptions);
    if (r.transportConstructor || (r.transportConstructor = Ce), r.transportOptions || (r.transportOptions = {
      server: e
    }), !r.uri && t.aor) {
    ...
    if (this.userAgent = new W(r), this.userAgent.delegate = {
   ...
   */
  async connect() {
    return this.logger.log("Connecting UserAgent..."), this.shouldBeConnected = !0, this.userAgent.state !== P.Started ? this.userAgent.start() : this.userAgent.reconnect();
  }
  /**
   * Disconnect.
   * @remarks
   ...
   */
  async disconnect() {
    return this.logger.log("Disconnecting UserAgent..."), this.userAgent.state === P.Stopped ? Promise.resolve() : (this.shouldBeConnected = !1, this.shouldBeRegistered = !1, this.registerer = void 0, this.userAgent.stop());
  }
  /**
   ...
   */
  async register(e) {
    return this.logger.log("Registering UserAgent...sss"), this.shouldBeRegistered = !0, e !== void 0 && (this.registererRegisterOptions = Object.assign({}, e)), this.registerer || (this.registerer = new z(this.userAgent, this.registererOptions), this.registerer.stateChange.addListener((t) => {
      switch (t) {
        case I.Initial:
          break;
        case I.Registered:
  ...
  async call(e, t, r) {
    ...
    if (s !== 0 && this.managedSessions.length > 5)
    ...
    this.options.iceStopWaitingOnServerReflexive && (t.delegate = t.delegate || {}, t.delegate.onSessionDescriptionHandler = (o) => {
      ...
      o.peerConnectionDelegate = {
        onicecandidate: (d) => {
          var p;
          ((p = d.candidate) === null || p === void 0 ? void 0 : p.type) === "srflx" && (this.logger.log(`[${n.id}] Found srflx ICE candidate, stop waiting...`), o.iceGatheringComplete());
        }
      };
    });
   ...
   */
  async answer(e, t) {
    return this.logger.log(`[${e.id}] Accepting Invitation...`), this.sessionExists(e) ? e instanceof we ? (t || (t = {}), t.sessionDescriptionHandlerOptions || (t.sessionDescriptionHandlerOptions = {}), t.sessionDescriptionHandlerOptions.constraints || (t.sessionDescriptionHandlerOptions.constraints = this.constraints), e.accept(t)) : Promise.reject(new Error("Session not instance of Invitation.")) : Promise.reject(new Error("Session does not exist."));
  }
  /**
   ...
   */
  async decline(e) {
    return this.logger.log(`[${e.id}] Rejecting Invitation...`), this.sessionExists(e) ? e instanceof we ? e.reject() : Promise.reject(new Error("Session not instance of Invitation.")) : Promise.reject(new Error("Session does not exist."));
  }
  /**
   * Hold call
...
Duration=` + s
  ...
  async message(e, t) {
    ...
    const r = W.makeURI(e);
    return r ? new yt(this.userAgent, r, t).message() : Promise.reject(new Error(`Failed to create a valid URI from "${e}"`));
  }
  /** Media constraints. */
  get constraints() {
  ...
  attemptRegistration(e = !1) {
    ...
    const t = () => this.registerer ? this.isConnected() ? this.userAgent.state === P.Stopped ? (this.logger.log("User agent stopped"), Promise.resolve()) : this.options.registerGuard ? this.options.registerGuard().catch((s) => {
    ...
    return new Promise((s, i) => {
      this.registrationAttemptTimeout = setTimeout(() => {
        t().then(() => {
          ...
          this.registrationAttemptTimeout = void 0, n instanceof xe ? s() : i(n);
        });
...
`, 2);
      ...
      let p;
      const g = /^(Duration\s?=\s?)([0-9]{1,4})(\s)?.*/;
      if (n[1] !== void 0 && g.test(n[1]) && (p = parseInt(n[1].replace(g, "$2"), 10)), !p) {
        r.reject();
        return;
      }
      r.accept().then(() => {
        if (this.delegate && this.delegate.onCallDTMFReceived) {
          ...
          this.delegate.onCallDTMFReceived(e, o, p);
        }
      }).catch((w) => {
  ...
  async setHold(e, t) {
    ...
    return n.held = t, e.invite(s).then(() => {
      ...
      throw n.held = !t, o instanceof xe && this.logger.error(`[${e.id}] A hold request is already in progress.`), o;
    });
  }
  /**
...
const dt = ft({
  ...
  connectStatus: Ee.WAIT_REQUEST_CONNECT,
  registerStatus: Te.UNREGISTERED,
  sessions: {},
  sessionTimer: {}
}), tr = () => pt(dt), sr = (a) => {
  if (!a)
    return null;
  const { sessions: e, sessionManager: t, sessionTimer: r } = tr(), s = e[a], [i, n] = oe(
    (t == null ? void 0 : t.isMuted(s)) || !1
  ), [o, d] = oe(
    (t == null ? void 0 : t.isHeld(s)) || !1
  ), p = s instanceof be ? Oe.OUTGOING : Oe.INCOMING, g = r[a];
  return {
    direction: p,
    session: s,
    timer: g,
    ...
    unmute: () => {
      t == null || t.unmute(s), n(!1);
    },
    isMuted: i,
    answer: () => t == null ? void 0 : t.answer(s),
    decline: () => t == null ? void 0 : t.decline(s),
    hangup: () => t == null ? void 0 : t.hangup(s)
  };
};
var je = /* @__PURE__ */ ((a) => (a.SIP_PROVIDER = "sip-provider", a))(je || {}), ht = /* @__PURE__ */ ((a) => (a.FAILED_CONNECT_SIP_USER = "Can't connect with SIP Server", a))(ht || {});
const ir = (a) => {
  const { options: e, mergedSessionManagerOptions: t = {}, children: r } = a, s = Ke(null), i = Ke(null), [n, o] = oe({}), [d, p] = oe({}), [g, w] = oe(
    null
  ), [b, y] = oe(
    Ee.WAIT_REQUEST_CONNECT
  ), [A, S] = oe(
    Te.UNREGISTERED
  ), B = We(
    (C) => {
    ...
    const ee = new Be(e.webSocketServer, {
      aor: `sip:${C.username}@${e.domain}`,
      userAgentOptions: {
      ...
      media: {
        ...
        remote: {
          audio: a.options.refAudioRemote ?? s.current,
          video: a.options.refVideoRemote ?? i.current
        }
      },
      delegate: {
        onCallCreated: (H) => {
          H.stateChange.addListener((N) => {
            console.info(
              je.SIP_PROVIDER,
              `Session ${H.id} changed to ${N}`
            ), B(H);
          }), B(H), p((N) => ({
            ...N,
            [H.id]: {
        ...
        onServerConnect() {
          y(Ee.CONNECTED), ee.register();
        },
        onServerDisconnect(H) {
          console.error(
            je.SIP_PROVIDER,
            ht.FAILED_CONNECT_SIP_USER,
            H
          ), y(Ee.DISCONNECTED);
        }
      },
  ...
  return /* @__PURE__ */ pe.createElement(pe.Fragment, null, /* @__PURE__ */ pe.createElement(
    dt.Provider,
    {
      value: {
        connectAndRegister: f,
        sessionManager: g,
        connectStatus: b,
        registerStatus: A,
        sessions: n,
    ...
    r
  ), /* @__PURE__ */ pe.createElement("audio", { ref: s }), /* @__PURE__ */ pe.createElement("video", { ref: i }));
};
export {
  Ee as CONNECT_STATUS,
  dt as ProviderContext,
  Te as RegisterStatus,
  ir as SIPProvider,
  Oe as SessionDirection,
  tr as useSIPProvider,
  sr as useSessionCall
};
